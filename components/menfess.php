...
<section id="menfess" class="py-20 relative bg-[#f8fafc]">
    ...
    <div class="container mx-auto px-4 relative z-10 max-w-7xl">
        ...
        <div class="w-full relative group/slider">
            ...
            <div id="menfess-wall" class="flex flex-col flex-wrap content-start gap-4 md:gap-6 overflow-x-auto py-4 md:py-10 px-4 md:px-8 no-scrollbar scroll-smooth h-[600px] md:h-[650px]">
