...
<section id="leaderboard" class="py-24 relative overflow-hidden bg-white">
    ...
    <div class="container mx-auto px-4 relative z-10 max-w-5xl">
        ...
        <div class="flex flex-col md:flex-row items-end justify-center gap-4 md:gap-8 mb-20 relative">
            
            <?php if(isset($top3[1])): $u2 = formatUsername($top3[1]['nama_peserta']); ?>
            <div class="order-2 md:order-1 w-full md:w-[30%] flex flex-col items-center group relative z-10">
                <div class="relative mb-[-40px] z-20 transition-transform duration-300 group-hover:-translate-y-2">
                    <div class="w-24 h-24 rounded-full p-1 bg-gradient-to-b from-slate-100 to-slate-300 shadow-xl shadow-slate-400/30">
                        <img src="https://api.dicebear.com/7.x/notionists/svg?seed=<?= $u2 ?>&backgroundColor=e2e8f0" 
                             class="w-full h-full rounded-full object-cover bg-slate-50">
                    </div>
            ...
            <div class="order-1 md:order-2 w-full md:w-[35%] flex flex-col items-center z-20 -mt-12 md:-mt-0 group">
                ...
                <div class="relative mb-[-50px] z-20 transition-transform duration-300 group-hover:-translate-y-3">
                    ...
                    <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 bg-red-600 text-white text-sm font-black px-4 py-1.5 rounded-full border-2 border-yellow-300 shadow-lg tracking-wider">
                        #1 CHAMPION
                    </div>
                </div>
            ...
            <div class="order-3 md:order-3 w-full md:w-[30%] flex flex-col items-center group relative z-10">
                <div class="relative mb-[-40px] z-20 transition-transform duration-300 group-hover:-translate-y-2">
