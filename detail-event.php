...
<head>
    ...
    <style>
        :root { --bg-neon: #17FFB2; --text-dark: #0E5941; }
        body { background-color: var(--bg-neon); color: var(--text-dark); font-family: 'Nunito', sans-serif; }
        .font-fun { font-family: 'Fredoka', sans-serif; }
        
        .bg-pattern {
            background-image: radial-gradient(#0E5941 1px, transparent 1px);
            background-size: 24px 24px; opacity: 0.1;
        }

        /* Card Hover Effect */
        .card-box { transition: transform 0.3s cubic-bezier(0.34, 1.56, 0.64, 1), box-shadow 0.3s ease; }
        .card-box:hover {
        ...
        .modal-content { transform: scale(0.9); opacity: 0; transition: all 0.3s ease; }
    ...
    <div class="relative z-10 container mx-auto px-4 py-12 max-w-6xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 auto-rows-fr">
            ...
            <div onclick="toggleModal('modal-<?= $row['id'] ?>')" 
                 class="card-box bg-white rounded-[2rem] p-6 flex flex-col items-center text-center shadow-lg relative overflow-hidden group border-4 border-transparent hover:border-[#0E5941]/10 h-full">
                ...
                <div class="mt-auto pt-4">
                    <span class="inline-block text-sm font-bold border-2 border-[#0E5941] text-[#0E5941] px-4 py-1 rounded-full group-hover:bg-[#0E5941] group-hover:text-white transition">
                        Lihat Detail
                    </span>
                </div>
            </div>
